...
SECRET_KEY = '#sp!p1jt8+%y+kx#s4y)c3tb6mbahd$is%#4e(7$^yk*dgi#u2'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [u'127.0.0.1', u'detrakt.pythonanywhere.com', u'localhost']
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'webblog/media')
MEDIAFILES_DIRS = [
